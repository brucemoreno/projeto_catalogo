...
class CriticasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create critica" do
    assert_difference("Critica.count") do
      post criticas_url, params: { critica: { comentario: @critica.comentario, filme: @critica.filme } }
    end
  ...
  test "should update critica" do
    patch critica_url(@critica), params: { critica: { comentario: @critica.comentario, filme: @critica.filme } }
