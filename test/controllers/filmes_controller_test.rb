...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { ano_de_lançamento: @filme.ano_de_lançamento, ator_id: @filme.ator_id, criticas_id: @filme.criticas_id, titulo: @filme.titulo } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { ano_de_lançamento: @filme.ano_de_lançamento, ator_id: @filme.ator_id, criticas_id: @filme.criticas_id, titulo: @filme.titulo } }
