...
class AtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ator" do
    assert_difference("Ator.count") do
      post ators_url, params: { ator: { ano_de_nascimento: @ator.ano_de_nascimento, email: @ator.email, nome: @ator.nome } }
    end
  ...
  test "should update ator" do
    patch ator_url(@ator), params: { ator: { ano_de_nascimento: @ator.ano_de_nascimento, email: @ator.email, nome: @ator.nome } }
